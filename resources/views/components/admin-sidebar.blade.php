        ...
        <ul class="space-y-2">
          ...
          <li>
            ...
            <ul id="dropdown-pages" class="hidden py-2 space-y-2">
              <li>
                <x-side-link href="/admin/students" :active="request()->is('students')">Student</x-side-link>
              </li>
              <li>
                <x-side-link href="/admin/grades" :active="request()->is('grades-admin')">Grade</x-side-link>
              </li>
              <li>
                <x-side-link href="/admin/departments" :active="request()->is('departments')">Department</x-side-link>
              </li>
            </ul>
          </li>
          <li>
