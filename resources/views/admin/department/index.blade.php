                    ...
                    <tr
                        ...
                        <td class="px-6 py-4 text-center">
                            <div class="flex items-center justify-center space-x-2">
                                <button id="modalDetail" class="modalDetailBtn" data-id="{{ $department->id }}"
                                    data-name="{{ $department->name }}" data-desc="{{ $department->desc }}"
                                    data-modal-target="readDepartmentModal" data-modal-toggle="readDepartmentModal"
                                    type="button">
        ...
        document.addEventListener("DOMContentLoaded", function(event) {
            ...
            modalDetailBtns.forEach((btn) => {
                btn.addEventListener('click', function() {
                    ...
                    modalDescription.textContent = this.getAttribute('data-desc');
